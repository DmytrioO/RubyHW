...
puts '4. В улюбленця є шкала сну. Вона збільшується на 10 пунктів за кожну годину сну, зменшується на 8 за кожну годину бадьорості та на 12 - гри.'
puts '5. Якщо шкала сну улюбленця впаде нижче 20 - він не зможе з тобою гратися, якщо ж нижче 10 - почне втрачати 8 пунктів здоров\'я на годину'
puts '6. В улюбленця є шкала настрою. Її можна поповнювати іграми, пестощами, розмовами та ласощами. Вона падає щогодини на 5 пунктів(за вийнятком розваг). Якщо шкала впаде нижче 10 - улюбленець почне втрачати 2 пункти здоров\'я на годину'
...
puts '10. Для взаємодії з улюбленцем в термінал вводяться команди типу: спати, погодувати, дати ласощі(скорочено - ласощі), пестити і т.п.'
puts '11. Якщо по ходу гри ти забудеш, або не знатимеш якусь команду - вводь help!'
puts '12. Для виходу з гри введи команду: вийти(вихід).'
puts '13. Від гри необхідно отримувати задоволення, інакше буде нецікаво гратися ;)'
puts ''
pet.set_time
